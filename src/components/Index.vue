<template>
  <div>
    ...
    <div v-if="!loadingAll" class="_3_col--grid">
      <h2 class="card">Total Cases: <br />{{ all.cases }}</h2>
      <h2 class="card">Total Recovered: <br />{{ all.recovered }}</h2>
      <h2 class="card">Total Deaths: <br />{{ all.deaths }}</h2>
    </div>
  ...
  <div class="card">
    ...
    <div class="table" v-if="!loadingConutries">
